...
def frame_processor(cam_id):
    ...
    while True:
        ...
        # Give a slight delay to avoid busy waiting.
        time.sleep(0.001)

###############################################################################
# Main Function: Spawning Threads and Displaying Only the Active Stream
###############################################################################
if __name__ == "__main__":
    ...
    # In the main thread, display only the active camera's frame.
    while True:
    ...
    # Optionally join threads if needed (depends on your exit strategy)
